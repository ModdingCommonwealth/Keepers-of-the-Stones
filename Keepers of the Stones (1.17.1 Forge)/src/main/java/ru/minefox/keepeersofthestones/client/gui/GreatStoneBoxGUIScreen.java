...
public class GreatStoneBoxGUIScreen extends AbstractContainerScreen<GreatStoneBoxGUIMenu> {
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public GreatStoneBoxGUIScreen(GreatStoneBoxGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 61, this.topPos + 8, 0, 0, 16, 16, 16, 16);

		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/moon_master.png"));
		this.blit(ms, this.leftPos + 97, this.topPos + 8, 0, 0, 16, 16, 16, 16);

		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/creation_master.png"));
		this.blit(ms, this.leftPos + 62, this.topPos + 44, 0, 0, 16, 16, 16, 16);
