...
public class MediumStoneBoxGUIScreen extends AbstractContainerScreen<MediumStoneBoxGUIMenu> {
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public MediumStoneBoxGUIScreen(MediumStoneBoxGUIMenu container, Inventory inventory, Component text) {
	...
	protected void renderBg(PoseStack ms, float partialTicks, int gx, int gy) {
		...
		this.blit(ms, this.leftPos + 62, this.topPos + 26, 0, 0, 16, 16, 16, 16);
		...
		this.blit(ms, this.leftPos + 79, this.topPos + 8, 0, 0, 16, 16, 16, 16);

		RenderSystem.setShaderTexture(0, new ResourceLocation("power:textures/light_master.png"));
		this.blit(ms, this.leftPos + 61, this.topPos + 63, 0, 0, 16, 16, 16, 16);
		...
		this.blit(ms, this.leftPos + 79, this.topPos + 45, 0, 0, 16, 16, 16, 16);
