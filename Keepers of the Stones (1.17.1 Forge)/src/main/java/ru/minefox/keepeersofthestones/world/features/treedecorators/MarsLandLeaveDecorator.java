...
public class MarsLandLeaveDecorator extends LeaveVineDecorator {
	public static final MarsLandLeaveDecorator INSTANCE = new MarsLandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("mars_land_tree_leave_decorator");
