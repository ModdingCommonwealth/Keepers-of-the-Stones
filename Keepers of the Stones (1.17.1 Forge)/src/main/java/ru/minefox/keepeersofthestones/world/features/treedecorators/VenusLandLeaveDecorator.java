...
public class VenusLandLeaveDecorator extends LeaveVineDecorator {
	public static final VenusLandLeaveDecorator INSTANCE = new VenusLandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("venus_land_tree_leave_decorator");
