...
import ru.minefox.keepeersofthestones.procedures.IronShieldUseProcedure;
...
public class IronShieldItem extends Item {
	...
	public InteractionResult useOn(UseOnContext context) {
		...
		IronShieldUseProcedure.execute(context.getLevel(), context.getClickedPos().getX(), context.getClickedPos().getY(),
