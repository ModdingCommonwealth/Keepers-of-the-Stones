...
public class MarsLandFruitDecorator extends CocoaDecorator {
	public static final MarsLandFruitDecorator INSTANCE = new MarsLandFruitDecorator();
	public static com.mojang.serialization.Codec<MarsLandFruitDecorator> codec;
