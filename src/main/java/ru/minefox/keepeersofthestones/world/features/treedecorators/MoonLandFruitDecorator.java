...
public class MoonLandFruitDecorator extends CocoaDecorator {
	public static final MoonLandFruitDecorator INSTANCE = new MoonLandFruitDecorator();
	public static com.mojang.serialization.Codec<MoonLandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_land_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MoonLandFruitDecorator() {
		super(0.2f);
	}
