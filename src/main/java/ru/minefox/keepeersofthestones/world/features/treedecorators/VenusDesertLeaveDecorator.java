...
public class VenusDesertLeaveDecorator extends LeaveVineDecorator {
	public static final VenusDesertLeaveDecorator INSTANCE = new VenusDesertLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("venus_desert_tree_leave_decorator");
