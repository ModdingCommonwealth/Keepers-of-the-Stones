package ru.minefox.keepeersofthestones.world.features.treedecorators;
...
public class VenusDesertFruitDecorator extends CocoaDecorator {
	public static final VenusDesertFruitDecorator INSTANCE = new VenusDesertFruitDecorator();
	public static com.mojang.serialization.Codec<VenusDesertFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("venus_desert_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public VenusDesertFruitDecorator() {
		super(0.2f);
	}
