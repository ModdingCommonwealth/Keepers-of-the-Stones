...
public class VenusLandFruitDecorator extends CocoaDecorator {
	public static final VenusLandFruitDecorator INSTANCE = new VenusLandFruitDecorator();
	public static com.mojang.serialization.Codec<VenusLandFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("venus_land_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public VenusLandFruitDecorator() {
		super(0.2f);
	}
