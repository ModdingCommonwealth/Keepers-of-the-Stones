...
public class PowerModItems {
	...
	public static final Item WOOD_STONE_BOX = register(new WoodStoneBoxItem());
	public static final Item STONE_STONE_BOX = register(new StoneStoneBoxItem());
	public static final Item ANDESITE_STONE_BOX = register(new AndesiteStoneBoxItem());
	public static final Item IRON_STONE_BOX = register(new IronStoneBoxItem());
	public static final Item GOLD_STONE_BOX = register(new GoldStoneBoxItem());
	...
	public static final Item ENERGY_BLOCK = register(new EnergyBlockItem());
	...
	public static final Item SOUND_BARRIER_BLOCK = register(new SoundBarrierBlockItem());
	...
	public static final Item CLUSTER_BLOCK = register(new ClusterBlockItem());
	public static final Item CRYSTAL_SHIELD_BLOCK = register(new CrystalShieldBlockItem());
	...
	public static final Item VACUUM_WEB_BLOCK = register(new VacuumWebBlockItem());
	...
	public static final Item MOON_STONES_BLOCK = register(new MoonStonesBlockItem());
	...
	public static final Item BLACK_HOLE_BLOCK = register(new BlackHoleBlockItem());
	...
	public static final Item UNMULTIPLICATION_MOON_STONES_BLOCK = register(new UnmultiplicationMoonStonesItem());
