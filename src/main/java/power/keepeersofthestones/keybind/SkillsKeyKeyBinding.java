...
public class SkillsKeyKeyBinding extends PowerModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	private KeyBinding keys;

	public SkillsKeyKeyBinding(PowerModElements instance) {
		super(instance, 779);
	...
	public void initElements() {
		keys = new KeyBinding("key.power.skills_key", GLFW.GLFW_KEY_Y, "key.categories.stones");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			OpenSkillsGUIProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
