...
public class DetransformKeyKeyBinding extends PowerModElements.ModElement {
	@OnlyIn(Dist.CLIENT)
	...
	public void initElements() {
		keys = new KeyBinding("key.power.detransform_key", GLFW.GLFW_KEY_U, "key.categories.stones");
