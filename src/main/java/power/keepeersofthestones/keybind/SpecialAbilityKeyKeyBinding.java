...
public class SpecialAbilityKeyKeyBinding extends PowerModElements.ModElement {
	...
	public void initElements() {
		keys = new KeyBinding("key.power.special_ability_key", GLFW.GLFW_KEY_R, "key.categories.stone");
	...
	private static void pressAction(PlayerEntity entity, int type, int pressedms) {
		...
		if (type == 0) {
			...
			SpecialAbilityUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
