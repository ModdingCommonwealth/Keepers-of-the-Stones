...
public class OrangePortalBlock extends PowerModElements.ModElement {
	@ObjectHolder("power:orange_portal")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public boolean removedByPlayer(BlockState blockstate, World world, BlockPos pos, PlayerEntity entity, boolean willHarvest, FluidState fluid) {
			...
			RemoveOrangePortalProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world)).collect(HashMap::new,
