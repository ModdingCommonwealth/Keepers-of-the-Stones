...
public class GoldMagicBoxBlock extends PowerModElements.ModElement {
	@ObjectHolder("power:gold_magic_box")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.IRON).sound(SoundType.METAL).hardnessAndResistance(0.5f, 1000f).setLightLevel(s -> 0).notSolid()
