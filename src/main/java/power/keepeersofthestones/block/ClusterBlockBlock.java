...
public class ClusterBlockBlock extends PowerModElements.ModElement {
	@ObjectHolder("power:cluster_block")
	...
	public static class CustomBlock extends FallingBlock {
		...
		public void onBlockAdded(BlockState blockstate, World world, BlockPos pos, BlockState oldState, boolean moving) {
			...
			ClusterSharpIsGoneProcedure.executeProcedure(Stream
		...
		public void onEntityCollision(BlockState blockstate, World world, BlockPos pos, Entity entity) {
			...
			EntityOnClusterBlockProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
