...
public class StoneMagicBoxBlock extends PowerModElements.ModElement {
	@ObjectHolder("power:stone_magic_box")
	...
	public static class CustomBlock extends Block implements IWaterLoggable {
		...
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(0.5f, 1000f).setLightLevel(s -> 0).notSolid()
