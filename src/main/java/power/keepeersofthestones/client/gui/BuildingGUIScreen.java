...
public class BuildingGUIScreen extends AbstractContainerScreen<BuildingGUIMenu> {
	...
	protected void renderLabels(PoseStack poseStack, int mouseX, int mouseY) {
		this.font.draw(poseStack, "Select the structure you want to place", 28, 2, -12829636);
	}
	...
	public void init() {
		...
		this.addRenderableWidget(new Button(this.leftPos + 19, this.topPos + 20, 67, 20, new TextComponent("Fountain"), e -> {
			if (true) {
