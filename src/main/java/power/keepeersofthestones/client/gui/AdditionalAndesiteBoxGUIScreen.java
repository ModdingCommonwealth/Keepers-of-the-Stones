...
public class AdditionalAndesiteBoxGUIScreen extends AbstractContainerScreen<AdditionalAndesiteBoxGUIMenu> {
	private final Level world;
	private final int x, y, z;
	private final Player entity;

	public AdditionalAndesiteBoxGUIScreen(AdditionalAndesiteBoxGUIMenu container, Inventory inventory, Component text) {
