...
public class SpawnAnimalsGUIGuiWindow extends ContainerScreen<SpawnAnimalsGUIGui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 78, this.guiTop + 79, 51, 20, new StringTextComponent("Sheep"), e -> {
			if (true) {
				PowerMod.PACKET_HANDLER.sendToServer(new SpawnAnimalsGUIGui.ButtonPressedMessage(5, x, y, z));
				SpawnAnimalsGUIGui.handleButtonAction(entity, 5, x, y, z);
			}
		}));
	}
}
