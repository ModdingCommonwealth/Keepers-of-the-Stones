...
public class MediumStoneBoxGUIGui extends PowerModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public MediumStoneBoxGUIGui(PowerModElements instance) {
		super(instance, 171);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("medium_stone_box_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, MediumStoneBoxGUIGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 61, 26) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (GreeneryStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 97, 26) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (AnimalsStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 79, 8) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (MetalStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 79, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (VacuumStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 61, 62) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (LightStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(6, this.addSlot(new SlotItemHandler(internal, 6, 97, 62) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (ShadowStoneItem.block == stack.getItem());
				}
			}));
			int si;
			int sj;
