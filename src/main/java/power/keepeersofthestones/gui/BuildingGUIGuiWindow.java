...
public class BuildingGUIGuiWindow extends ContainerScreen<BuildingGUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Select the structure you want to place", 28, 2, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 19, this.guiTop + 20, 67, 20, new StringTextComponent("Fountain"), e -> {
			if (true) {
