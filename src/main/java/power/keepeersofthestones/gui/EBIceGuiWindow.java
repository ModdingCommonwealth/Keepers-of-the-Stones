...
@OnlyIn(Dist.CLIENT)
public class EBIceGuiWindow extends ContainerScreen<EBIceGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = EBIceGui.guistate;

	public EBIceGuiWindow(EBIceGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerBackgroundLayer(MatrixStack ms, float partialTicks, int gx, int gy) {
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("power:textures/screens/ice_stone.png"));
		...
		Minecraft.getInstance().getTextureManager().bindTexture(new ResourceLocation("power:textures/screens/ice_element.png"));
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "Element: Ice", -162, -67, -12829636);
		this.font.drawString(ms, "Force: Freezing", -162, -49, -12829636);
	}
