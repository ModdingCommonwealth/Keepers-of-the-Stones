...
public class RedstoneBundleGUIGuiWindow extends ContainerScreen<RedstoneBundleGUIGui.GuiContainerMod> {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		this.font.drawString(ms, "Select the mechanism to add", 15, 7, -12829636);
	}
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 15, this.guiTop + 25, 135, 20, new StringTextComponent("Piston"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 15, this.guiTop + 52, 135, 20, new StringTextComponent("Piston extension"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 15, this.guiTop + 79, 135, 20, new StringTextComponent("Observer "), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 15, this.guiTop + 106, 135, 20, new StringTextComponent("Redstone Block"), e -> {
			if (true) {
