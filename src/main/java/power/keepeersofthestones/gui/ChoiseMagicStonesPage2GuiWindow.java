...
public class ChoiseMagicStonesPage2GuiWindow extends ContainerScreen<ChoiseMagicStonesPage2Gui.GuiContainerMod> {
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 60, 56, 20, new StringTextComponent(" Creation"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 87, 56, 20, new StringTextComponent(" Destruct"), e -> {
			if (true) {
		...
		this.addButton(new Button(this.guiLeft + 37, this.guiTop + 114, 56, 20, new StringTextComponent(" Cosmos"), e -> {
			if (true) {
