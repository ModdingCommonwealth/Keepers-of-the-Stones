...
public class GreatStoneBoxGUIGui extends PowerModElements.ModElement {
	public static HashMap guistate = new HashMap();
	private static ContainerType<GuiContainerMod> containerType = null;

	public GreatStoneBoxGUIGui(PowerModElements instance) {
		super(instance, 172);
	...
	private static class ContainerRegisterHandler {
		...
		public void registerContainer(RegistryEvent.Register<ContainerType<?>> event) {
			event.getRegistry().register(containerType.setRegistryName("great_stone_box_gui"));
		}
	}

	@OnlyIn(Dist.CLIENT)
	public void initElements() {
		DeferredWorkQueue.runLater(() -> ScreenManager.registerFactory(containerType, GreatStoneBoxGUIGuiWindow::new));
	}
		...
		public GuiContainerMod(int id, PlayerInventory inv, PacketBuffer extraData) {
			...
			this.customSlots.put(1, this.addSlot(new SlotItemHandler(internal, 1, 97, 8) {
				...
				public boolean isItemValid(ItemStack stack) {
					return (MoonStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(2, this.addSlot(new SlotItemHandler(internal, 2, 61, 8) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (SunStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(3, this.addSlot(new SlotItemHandler(internal, 3, 61, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (CreationStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(4, this.addSlot(new SlotItemHandler(internal, 4, 97, 44) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (DestructionStoneItem.block == stack.getItem());
				}
			}));
			this.customSlots.put(5, this.addSlot(new SlotItemHandler(internal, 5, 79, 26) {
				@Override
				public boolean isItemValid(ItemStack stack) {
					return (CosmosStoneItem.block == stack.getItem());
				}
			}));
			int si;
			int sj;
