...
@OnlyIn(Dist.CLIENT)
public class EBSpaceGuiWindow extends ContainerScreen<EBSpaceGui.GuiContainerMod> {
	private World world;
	private int x, y, z;
	private PlayerEntity entity;
	private final static HashMap guistate = EBSpaceGui.guistate;

	public EBSpaceGuiWindow(EBSpaceGui.GuiContainerMod container, PlayerInventory inventory, ITextComponent text) {
	...
	protected void drawGuiContainerForegroundLayer(MatrixStack ms, int mouseX, int mouseY) {
		...
		this.font.drawString(ms, "Element: Space", -162, -67, -12829636);
		this.font.drawString(ms, "Force: Traveling", -162, -49, -12829636);
	}
