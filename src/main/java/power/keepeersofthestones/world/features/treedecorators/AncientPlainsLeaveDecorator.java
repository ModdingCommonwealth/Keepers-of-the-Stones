...
public class AncientPlainsLeaveDecorator extends LeaveVineDecorator {
	public static final AncientPlainsLeaveDecorator INSTANCE = new AncientPlainsLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_plains_tree_leave_decorator");
