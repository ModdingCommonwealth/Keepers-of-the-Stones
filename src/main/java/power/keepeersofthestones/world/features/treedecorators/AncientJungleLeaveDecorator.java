...
public class AncientJungleLeaveDecorator extends LeaveVineDecorator {
	public static final AncientJungleLeaveDecorator INSTANCE = new AncientJungleLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("ancient_jungle_tree_leave_decorator");
