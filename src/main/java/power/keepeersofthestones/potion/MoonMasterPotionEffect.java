...
public class MoonMasterPotionEffect {
	@ObjectHolder("power:moon_master")
	...
	public static class EffectCustom extends Effect {
		public EffectCustom() {
			super(EffectType.BENEFICIAL, -3355393);
			setRegistryName("moon_master");
		}

		@Override
		public String getName() {
			return "effect.moon_master";
		}
		...
		public void performEffect(LivingEntity entity, int amplifier) {
			...
			MoonMasterEffectsProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
