...
public class BatteryCreateTickProcedure {
	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		}.getItemStack(new BlockPos(x, y, z), (int) (0))).getItem() == CosmosStoneItem.block && new Object() {
			public int getAmount(IWorld world, BlockPos pos, int sltid) {
				AtomicInteger _retval = new AtomicInteger(0);
				TileEntity _ent = world.getTileEntity(pos);
				if (_ent != null) {
			...
			if (new Object() {
				...
				if (new Object() {
					...
					}
					{
						...
						if (_ent != null) {
							final int _sltid = (int) (2);
							final ItemStack _setstack = new ItemStack(CosmosBatteryItem.block);
							_setstack.setCount((int) 1);
							_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
								if (capability instanceof IItemHandlerModifiable) {
									((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
					...
					}
					{
						...
						if (_ent != null) {
							final int _sltid = (int) (3);
							final ItemStack _setstack = new ItemStack(CosmosStoneItem.block);
							_setstack.setCount((int) 1);
							_ent.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY, null).ifPresent(capability -> {
								if (capability instanceof IItemHandlerModifiable) {
									((IItemHandlerModifiable) capability).setStackInSlot(_sltid, _setstack);
