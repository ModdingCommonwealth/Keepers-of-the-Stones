	...
	public static void executeProcedure(Map<String, Object> dependencies) {
		...
		if (world.getWorldInfo().getGameRulesInstance().getBoolean(CanRechoiseStoneGameRule.gamerule) == true) {
			...
			if ((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(TechnologyStoneItem.block)) : false) {
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(TechnologyStoneItem.block);
					((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
							((PlayerEntity) entity).container.func_234641_j_());
				}
			...
			if ((entity instanceof PlayerEntity)
					? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(TeleportationStoneItem.block))
					: false) {
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(TeleportationStoneItem.block);
					((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
							((PlayerEntity) entity).container.func_234641_j_());
				}
			...
			if ((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(ExplosionStoneItem.block)) : false) {
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(ExplosionStoneItem.block);
					((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
							((PlayerEntity) entity).container.func_234641_j_());
				}
			...
			if ((entity instanceof PlayerEntity) ? ((PlayerEntity) entity).inventory.hasItemStack(new ItemStack(AmberStoneItem.block)) : false) {
				if (entity instanceof PlayerEntity) {
					ItemStack _stktoremove = new ItemStack(AmberStoneItem.block);
					((PlayerEntity) entity).inventory.func_234564_a_(p -> _stktoremove.getItem() == p.getItem(), (int) 1,
							((PlayerEntity) entity).container.func_234641_j_());
				}
