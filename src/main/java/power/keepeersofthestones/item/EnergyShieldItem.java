...
public class EnergyShieldItem extends PowerModElements.ModElement {
	@ObjectHolder("power:energy_shield")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			EnergyShieldProcedureProcedure.executeProcedure(Stream
