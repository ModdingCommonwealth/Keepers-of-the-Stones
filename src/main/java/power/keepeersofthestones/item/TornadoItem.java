...
public class TornadoItem extends PowerModElements.ModElement {
	@ObjectHolder("power:tornado_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:tornado_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:tornado_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:tornado_boots")
