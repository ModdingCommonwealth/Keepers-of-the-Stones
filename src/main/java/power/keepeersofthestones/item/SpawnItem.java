...
import power.keepeersofthestones.gui.SpawnAnimalsGUIGuiWindow;
...
public class SpawnItem extends PowerModElements.ModElement {
	@ObjectHolder("power:spawn")
	public static final Item block = null;

	public SpawnItem(PowerModElements instance) {
		super(instance, 251);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof SpawnAnimalsGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Spawn");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new SpawnAnimalsGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
