...
public class CrestcentItem extends PowerModElements.ModElement {
	@ObjectHolder("power:crestcent_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:crestcent_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:crestcent_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:crestcent_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "power:textures/models/armor/moon__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
