...
import power.keepeersofthestones.gui.CultivationGUIGuiWindow;
...
public class CultivationItem extends PowerModElements.ModElement {
	@ObjectHolder("power:cultivation")
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CultivationGUIGuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CultivationGUIGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
