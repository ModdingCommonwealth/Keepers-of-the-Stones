...
public class LavaItem extends PowerModElements.ModElement {
	@ObjectHolder("power:lava_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:lava_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:lava_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:lava_boots")
	public static final Item boots = null;

	public LavaItem(PowerModElements instance) {
		super(instance, 235);
	}
