...
public class DestructionItem extends PowerModElements.ModElement {
	@ObjectHolder("power:destruction_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:destruction_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:destruction_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:destruction_boots")
