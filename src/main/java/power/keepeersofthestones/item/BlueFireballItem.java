...
import power.keepeersofthestones.entity.renderer.BlueFireballRenderer;
...
public class BlueFireballItem extends PowerModElements.ModElement {
	@ObjectHolder("power:blue_fireball")
	public static final Item block = null;
	public static final EntityType arrow = (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
			.setShouldReceiveVelocityUpdates(true).setTrackingRange(64).setUpdateInterval(1).setCustomClientFactory(ArrowCustomEntity::new)
			.size(0.5f, 0.5f)).build("projectile_blue_fireball").setRegistryName("projectile_blue_fireball");

	public BlueFireballItem(PowerModElements instance) {
		super(instance, 729);
		FMLJavaModLoadingContext.get().getModEventBus().register(new BlueFireballRenderer.ModelRegisterHandler());
	}
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1f, 12, 2);
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(BlueFireballItem.block);
		}
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			BlueFlameBurnBlockProcedure.executeProcedure(Stream
