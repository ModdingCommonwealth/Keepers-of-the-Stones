...
public class SnowGolemCreatorItem extends PowerModElements.ModElement {
	@ObjectHolder("power:snow_golem_creator")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResultType onItemUseFirst(ItemStack stack, ItemUseContext context) {
			...
			GolemCreateProcedure.executeProcedure(Stream
