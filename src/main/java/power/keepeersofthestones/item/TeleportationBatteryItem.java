...
public class TeleportationBatteryItem extends PowerModElements.ModElement {
	@ObjectHolder("power:teleportation_battery")
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			TeleportationBatteryUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
