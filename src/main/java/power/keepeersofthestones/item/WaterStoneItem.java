...
public class WaterStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:water_stone")
	public static final Item block = null;

	public WaterStoneItem(PowerModElements instance) {
		super(instance, 3);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			WaterStoneUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
