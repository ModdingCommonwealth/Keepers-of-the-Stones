...
import power.keepeersofthestones.entity.renderer.PlasmaBallRenderer;
...
public class PlasmaBallItem extends PowerModElements.ModElement {
	@ObjectHolder("power:plasma_ball")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(PlasmaBallItem.block);
		}
