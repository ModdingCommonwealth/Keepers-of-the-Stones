...
import power.keepeersofthestones.entity.renderer.MegawattRenderer;
...
public class MegawattItem extends PowerModElements.ModElement {
	@ObjectHolder("power:megawatt")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MegawattItem.block);
		}
		...
		public void onEntityHit(EntityRayTraceResult entityRayTraceResult) {
			...
			MegawattInEntityProcedure.executeProcedure(Stream
