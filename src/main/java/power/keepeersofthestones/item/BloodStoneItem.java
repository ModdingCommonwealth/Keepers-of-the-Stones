...
public class BloodStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:blood_stone")
	public static final Item block = null;

	public BloodStoneItem(PowerModElements instance) {
		super(instance, 23);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			BloodStoneUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
