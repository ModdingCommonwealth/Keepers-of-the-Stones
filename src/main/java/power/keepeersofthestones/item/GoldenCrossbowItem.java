...
import power.keepeersofthestones.entity.renderer.GoldenCrossbowRenderer;
...
public class GoldenCrossbowItem extends PowerModElements.ModElement {
	@ObjectHolder("power:golden_crossbow")
	...
	public static class ItemRanged extends Item {
		...
		public void onPlayerStoppedUsing(ItemStack itemstack, World world, LivingEntity entityLiving, int timeLeft) {
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 1.2000000000000002f, 6, 4);
