...
import power.keepeersofthestones.entity.renderer.MagicFireballRenderer;
...
public class MagicFireballItem extends PowerModElements.ModElement {
	@ObjectHolder("power:magic_fireball")
		...
		public Multimap<Attribute, AttributeModifier> getAttributeModifiers(EquipmentSlotType slot) {
			if (slot == EquipmentSlotType.MAINHAND) {
				...
				builder.put(Attributes.ATTACK_DAMAGE,
						new AttributeModifier(ATTACK_DAMAGE_MODIFIER, "Ranged item modifier", (double) 6, AttributeModifier.Operation.ADDITION));
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(MagicFireballItem.block);
		}
