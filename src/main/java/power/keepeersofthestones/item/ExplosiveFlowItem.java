...
import power.keepeersofthestones.entity.renderer.ExplosiveFlowRenderer;
...
public class ExplosiveFlowItem extends PowerModElements.ModElement {
	@ObjectHolder("power:explosive_flow")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(ExplosiveFlowItem.block);
		}
