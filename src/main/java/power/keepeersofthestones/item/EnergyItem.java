...
public class EnergyItem extends PowerModElements.ModElement {
	@ObjectHolder("power:energy_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:energy_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:energy_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:energy_boots")
