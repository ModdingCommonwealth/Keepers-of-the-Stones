...
public class RainStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:rain_stone")
	public static final Item block = null;

	public RainStoneItem(PowerModElements instance) {
		super(instance, 20);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			RainStoneUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
