...
public class TornadoCreateItem extends PowerModElements.ModElement {
	@ObjectHolder("power:tornado_create")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(TornadoCreateItem.block);
		}
		...
		public void func_230299_a_(BlockRayTraceResult blockRayTraceResult) {
			...
			TornadoCreateOnBlockProcedure.executeProcedure(Stream
