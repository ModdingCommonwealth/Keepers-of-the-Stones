...
public class ShadowarmorItem extends PowerModElements.ModElement {
	@ObjectHolder("power:shadow_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:shadow_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:shadow_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:shadow_boots")
