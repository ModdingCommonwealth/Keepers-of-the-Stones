...
public class LightItem extends PowerModElements.ModElement {
	@ObjectHolder("power:light_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:light_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:light_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:light_boots")
	public static final Item boots = null;

	public LightItem(PowerModElements instance) {
		super(instance, 450);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "power:textures/models/armor/light__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
