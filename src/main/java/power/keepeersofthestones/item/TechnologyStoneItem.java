...
public class TechnologyStoneItem extends PowerModElements.ModElement {
	@ObjectHolder("power:technology_stone")
	public static final Item block = null;

	public TechnologyStoneItem(PowerModElements instance) {
		super(instance, 8);
	}
	...
	public static class ItemCustom extends Item {
		...
		public ActionResult<ItemStack> onItemRightClick(World world, PlayerEntity entity, Hand hand) {
			...
			TechnologyStoneUseProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("entity", entity)).collect(HashMap::new,
