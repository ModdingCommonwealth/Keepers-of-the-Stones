...
public class TechnologyItem extends PowerModElements.ModElement {
	@ObjectHolder("power:technology_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:technology_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:technology_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:technology_boots")
