...
public class LavaHammerItem extends PowerModElements.ModElement {
	@ObjectHolder("power:lava_hammer")
	...
	public void initElements() {
		elements.items.add(() -> new PickaxeItem(new IItemTier() {
			...
			public ActionResultType onItemUse(ItemUseContext context) {
				...
				DestroyRocksProcedure.executeProcedure(Stream.of(new AbstractMap.SimpleEntry<>("world", world), new AbstractMap.SimpleEntry<>("x", x),
