...
public class ExplodeItem extends PowerModElements.ModElement {
	@ObjectHolder("power:explode_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:explode_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:explode_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:explode_boots")
