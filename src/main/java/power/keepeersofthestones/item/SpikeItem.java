...
import power.keepeersofthestones.entity.renderer.SpikeRenderer;
...
public class SpikeItem extends PowerModElements.ModElement {
	@ObjectHolder("power:spike")
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(SpikeItem.block);
		}
