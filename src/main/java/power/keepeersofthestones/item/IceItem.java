...
public class IceItem extends PowerModElements.ModElement {
	@ObjectHolder("power:ice_helmet")
	public static final Item helmet = null;
	@ObjectHolder("power:ice_chestplate")
	public static final Item body = null;
	@ObjectHolder("power:ice_leggings")
	public static final Item legs = null;
	@ObjectHolder("power:ice_boots")
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(null)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "power:textures/models/armor/ice__layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
