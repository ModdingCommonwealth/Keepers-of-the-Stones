...
public class MoonLandLeaveDecorator extends LeaveVineDecorator {
	public static final MoonLandLeaveDecorator INSTANCE = new MoonLandLeaveDecorator();
	public static com.mojang.serialization.Codec<LeaveVineDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_land_tree_leave_decorator");
