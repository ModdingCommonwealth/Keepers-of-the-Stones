...
public class MoonOceanFruitDecorator extends CocoaDecorator {
	public static final MoonOceanFruitDecorator INSTANCE = new MoonOceanFruitDecorator();
	public static com.mojang.serialization.Codec<MoonOceanFruitDecorator> codec;
	public static TreeDecoratorType<?> tdt;
	static {
		codec = com.mojang.serialization.Codec.unit(() -> INSTANCE);
		tdt = new TreeDecoratorType<>(codec);
		tdt.setRegistryName("moon_ocean_tree_fruit_decorator");
		ForgeRegistries.TREE_DECORATOR_TYPES.register(tdt);
	}

	public MoonOceanFruitDecorator() {
		super(0.2f);
	}
